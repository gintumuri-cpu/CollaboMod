...
public class EntityRegister {
        ...
        // グラム・デモリッションの登録
        public static final RegistryObject<EntityType<EntityGramDemolition>> GRAM_DEMOLITION = ENTITIES.register(
                        "gram_demolition",
        ...
        public static final RegistryObject<EntityType<EntityMistDispersion>> MIST_DISPERSION = ENTITIES.register(
                        "mist_dispersion",
        ...
        public static final RegistryObject<EntityType<EntitySciencePhenomenon>> MATERIAL_BURST = ENTITIES.register(
                        "material_burst",
        ...
        public static final RegistryObject<EntityType<EntityMagicSequence>> MAGIC_SEQUENCE = ENTITIES.register(
                        "magic_sequence",
        ...
        public static final RegistryObject<EntityType<EntitySciencePhenomenon>> SCIENCE_PHENOMENON = ENTITIES.register(
                        "science_phenomenon",
                        () -> EntityType.Builder
                                        .<EntitySciencePhenomenon>of((t, l) -> new EntitySciencePhenomenon(t, l),
                                                        MobCategory.MISC)
                                        .sized(1.0F, 1.0F).clientTrackingRange(10).updateInterval(1)
                                        .build("science_phenomenon"));

        public static final RegistryObject<EntityType<ResidualField>> RESIDUAL_FIELD = ENTITIES.register(
                        "residual_field",
                        () -> EntityType.Builder.<ResidualField>of(ResidualField::new, MobCategory.MISC)
                                        .sized(0.5F, 0.5F).clientTrackingRange(10).updateInterval(5)
                                        .build("residual_field"));
